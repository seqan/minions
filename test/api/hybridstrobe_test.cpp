...
TEST_F(hybridstrobe_test, ungapped_kmer_hash)
{
    ...
    EXPECT_RANGE_EQ(result3_3_ungapped, (seqan3::detail::hybridstrobe_view<decltype(text3 | kmer_view),3>(text3 | kmer_view,1,3)));
}
...
TEST_F(hybridstrobe_test, gapped_kmer_hash)
{
    ...
    EXPECT_RANGE_EQ(result3_3_gapped, (seqan3::detail::hybridstrobe_view<decltype(text3 | gapped_kmer_view),3>(text3 | gapped_kmer_view,1,3)));
}
...
TEST_F(hybridstrobe_test, combinability)
{
    ...
    EXPECT_RANGE_EQ(result3_3_ungapped_start, (seqan3::detail::hybridstrobe_view<decltype(text3 | start_at_a | kmer_view),3>(text3 | start_at_a | kmer_view,1,3)));
    EXPECT_RANGE_EQ(result3_3_gapped_start, (seqan3::detail::hybridstrobe_view<decltype(text3 | start_at_a| gapped_kmer_view),3>(text3 | start_at_a | gapped_kmer_view,1,3)));
