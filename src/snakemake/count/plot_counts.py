...
minstrobemers2 = read_file([], ["minstrobemers_"+str(k)+"_2_"+str(1)+"_"+str(4+k)+"_counts.out" for k in strobe_range])
minstrobemers3 = read_file([], ["minstrobemers_"+str(k)+"_3_"+str(1)+"_"+str(4+k)+"_counts.out" for k in k_order3])
hybridstrobemers2 = read_file([],["hybridstrobemers_"+str(k)+"_2_"+str(1)+"_"+str(4+k)+"_counts.out" for k in strobe_range])
hybridstrobemers3 = read_file([],["hybridstrobemers_"+str(k)+"_3_"+str(1)+"_"+str(4+k)+"_counts.out" for k in k_order3])
randstrobemers2 = read_file([], ["randstrobemers_"+str(k)+"_2_"+str(1)+"_"+str(4+k)+"_counts.out" for k in strobe_range])
randstrobemers3 = read_file([],["randstrobemers_"+str(k)+"_3_"+str(1)+"_"+str(4+k)+"_counts.out" for k in k_order3])
minstrobemers28 = read_file([], ["minstrobemers_"+str(k)+"_2_"+str(1)+"_"+str(8+k)+"_counts.out" for k in strobe_range])
minstrobemers38 = read_file([], ["minstrobemers_"+str(k)+"_3_"+str(1)+"_"+str(8+k)+"_counts.out" for k in k_order3])
hybridstrobemers28 = read_file([],["hybridstrobemers_"+str(k)+"_2_"+str(1)+"_"+str(8+k)+"_counts.out" for k in strobe_range])
hybridstrobemers38 = read_file([],["hybridstrobemers_"+str(k)+"_3_"+str(1)+"_"+str(8+k)+"_counts.out" for k in k_order3])
randstrobemers28 = read_file([], ["randstrobemers_"+str(k)+"_2_"+str(1)+"_"+str(8+k)+"_counts.out" for k in strobe_range])
randstrobemers38 = read_file([],["randstrobemers_"+str(k)+"_3_"+str(1)+"_"+str(8+k)+"_counts.out" for k in k_order3])
