...
plt.plot(pos, [x[0] for x in minstrobemers2], color = colors[2], label='4')
plt.plot(pos, [x[0] for x in minstrobemers28], color = colors[5], label='8')
plt.plot(pos, [x[0] for x in original_minstrobemers2], color = colors[0], label='4 ori')
plt.plot(pos, [x[0] for x in original_minstrobemers28], color = colors[1], label='8 ori')
...
plt.plot(pos, [x[0] for x in hybridstrobemers2], color = colors[2], label='4')
plt.plot(pos, [x[0] for x in hybridstrobemers28], color = colors[5], label='8')
plt.plot(pos, [x[0] for x in original_hybridstrobemers2], color = colors[0], label='4 ori')
plt.plot(pos, [x[0] for x in original_hybridstrobemers28], color = colors[1], label='8 ori')
...
plt.plot(pos, [x[0] for x in randstrobemers2], color = colors[2], label='4')
plt.plot(pos, [x[0] for x in randstrobemers28], color = colors[5], label='8')
plt.plot(pos, [x[0] for x in original_randstrobemers2], color = colors[0], label='4 ori')
plt.plot(pos, [x[0] for x in original_randstrobemers28], color = colors[1], label='8 ori')
...
plt.plot(pos_order3, [x[0] for x in randstrobemers3], color = colors[2], label='4')
plt.plot(pos_order3, [x[0] for x in randstrobemers38], color = colors[5], label='8')
plt.plot(pos_order3, [x[0] for x in original_randstrobemers3], color = colors[0], label='4 ori')
