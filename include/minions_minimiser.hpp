...
struct minimiser_fn
{
    ...
    {
        //TODO: Reason why this file was copied because strobmers do not fullfill this as they are not views,
        // therefore this would lead to an error, but strobemers runs with minimisers, if this is commented out
