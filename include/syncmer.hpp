...
public:
    ...
    */
    syncmer_view(urng1_t urange1, urng2_t urange2, size_t const K, size_t const window_size, size_t const S) :
    ...
    */
    ...
    //!\endcond
    syncmer_view(other_urng1_t && urange1, other_urng2_t && urange2, size_t const K, size_t const window_size, size_t const S) :
...
syncmer_view(rng1_t &&, rng2_t &&, size_t const K, size_t const window_size, size_t const S) -> syncmer_view<std::views::all_t<rng1_t>, std::views::all_t<rng2_t>>;
...
struct syncmer_fn
{
    ...
    constexpr auto operator()(urng2_t urange2, const size_t K, const size_t window_size, const size_t S) const
    {
        return adaptor_from_functor{*this, urange2, K, window_size, S};
    }
    ...
    constexpr auto operator()(urng1_t && urange1, urng2_t && urange2, size_t const K, size_t const window_size, size_t const S) const
    {
        ...
        return syncmer_view{urange1, urange2, K, window_size, S};
    }
};
//![adaptor_def]
