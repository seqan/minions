...
private:
    ...
    //!\brief Iterator to the second strobe of minstrobe.
    urng_iterator_t second_iterator{};

    //!\brief Iterator to the third strobe of minstrobe, if order is 3.
    ...
    //!\brief Iterator to the left most value of the second window and hence the third strobe of minstrobe for bidirectionality, if order is 3.
 ...
 * 5 as `window_size`, the minstrobe values are `[(6,24),(26,47)]`.
 *
 * At the moment, only minstrobes of order (n) 2 or 3 is supported.
 *
 * ### View properties
 *
