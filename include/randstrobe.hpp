...
private:
    ...
    std::deque<value_t> second_it_values{};  //new!!

    std::vector<std::pair< unsigned int, urng_iterator_t>> window_vector;
    ...
    void window_first(const size_t window_min, const size_t window_max)    //hier werden randstrobes berechnet
    {
        ...
        // newly added
        auto v = std::vector<std::pair< unsigned int, urng_iterator_t>> window_vector;
...
struct randstrobe_fn
{
    ...
    constexpr auto operator()(urng_t && urange, size_t const window_min, size_t const window_max) const
    {
        ...
        return randstrobe_view{urange, window_min, window_max};
    }
};
//![adaptor_def]
