...
class modmer_view : public std::ranges::view_interface<modmer_view<urng1_t, urng2_t>>
{
private:
    static_assert(std::ranges::forward_range<urng1_t>, "The modmer_view only works on forward_ranges.");
    static_assert(std::ranges::forward_range<urng2_t>, "The modmer_view only works on forward_ranges.");
...
public:
    ...
    * \param[in] mod_used_2 The number of values in one window.
    */
    modmer_view(urng1_t urange1, size_t const mod_used_1, size_t const mod_used_2) :
        modmer_view{std::move(urange1), default_urng2_t{}, mod_used_1, mod_used_2}
    {}
    ...
    */
    ...
    //!\endcond
    modmer_view(other_urng1_t && urange1, size_t const mod_used_1, size_t const mod_used_2) :
        urange1{std::views::all(std::forward<other_urng1_t>(urange1))},
        urange2{default_urng2_t{}},
        mod_used_1{mod_used_1},
        mod_used_2{mod_used_2}
    {}
    ...
    * \param[in] mod_used_2 The number of values in one window.
    */
    modmer_view(urng1_t urange1, urng2_t urange2, size_t const mod_used_1, size_t const mod_used_2) :
    ...
    */
    ...
    //!\endcond
    modmer_view(other_urng1_t && urange1, other_urng2_t && urange2, size_t const mod_used_1, size_t const mod_used_2) :
        urange1{std::views::all(std::forward<other_urng1_t>(urange1))},
...
public:
    ...
    */
        ...
        mod_2{mod_used_2}
    {
        ...
        mod_used_2 = std::min<size_t>(mod_used_2, size);
...
/*    size_t mod_used_1{};
    ...
    bool next_modmer()
    {
        ...
        if constexpr (!second_range_is_given)
        {
            if ((*urng1_iterator % mod_1) % mod_2 == 0)
            {
...
modmer_view(rng1_t &&, size_t const mod_used_1, size_t const mod_used_2) -> modmer_view<std::views::all_t<rng1_t>>;

//!\brief A deduction guide for the view class template.
template <std::ranges::viewable_range rng1_t, std::ranges::viewable_range rng2_t>
modmer_view(rng1_t &&, rng2_t &&, size_t const mod_used_1, size_t const mod_used_2) -> modmer_view<std::views::all_t<rng1_t>,
...
struct modmer_fn
{
    ...
    constexpr auto operator()(size_t const mod_used_1, size_t const mod_used_2) const
    {
        return adaptor_from_functor{*this, mod_used_1, mod_used_2};
    }
    ...
    constexpr auto operator()(urng1_t && urange1, size_t const mod_used_1, size_t const mod_used_2) const
    {
        ...
        return modmer_view{urange1, mod_used_1, mod_used_2};
    }
};
//![adaptor_def]
